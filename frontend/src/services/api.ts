...
import type { Alert, InferenceResult, ModelStatus, SensorReading, StreamInfo } from '@/types'
...
export const sensorAPI = {
  getLatest: () => api.get<{ readings: SensorReading[] }>('/sensors/latest'),
...
export const modelAPI = {
  getStatus: () => api.get<ModelStatus>('/models/status'),
...
export const streamAPI = {
  ...
  stop: (cameraId: string) => api.post(`/streams/${cameraId}/stop`),

  getStatus: () => api.get<{ streams: Record<string, StreamInfo> }>('/streams/status'),
}
